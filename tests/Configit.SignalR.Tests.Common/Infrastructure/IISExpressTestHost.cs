...
using Configit.SignalR.Tests.Common.Infrastructure.IIS;
...
namespace Configit.SignalR.Tests.Common.Infrastructure
{
    public class IISExpressTestHost : ITestHost
    {
        ...
        {
            using (Stream resourceStream = typeof(IISExpressTestHost).Assembly.GetManifestResourceStream("Configit.SignalR.Tests.Common.Infrastructure.IIS.site.web.config"))
            {
