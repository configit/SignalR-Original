...
namespace Configit.SignalR.Tests.Common.Infrastructure
{
    public static class ClientAssertExtensions
    {
        ...
        public static void SendWithTimeout(this Connection connection, object value)
        {
            SendWithTimeout(connection, value, _defaultTimeout);
        }

        public static void SendWithTimeout(this Connection connection, object value, TimeSpan timeout)
        {
        ...
        public static void SendWithTimeout(this Connection connection, string data)
        {
            SendWithTimeout(connection, data, _defaultTimeout);
        }

        public static void SendWithTimeout(this Connection connection, string data, TimeSpan timeout)
        {
