...
namespace Configit.SignalR.Infrastructure
{
    ...
    public class PerformanceCounterManager : IPerformanceCounterManager
    {
        ...
        public PerformanceCounterManager(DefaultDependencyResolver resolver)
            : this(resolver.Resolve<Configit.SignalR.Tracing.ITraceManager>())
        {
        ...
        /// </summary>
        public PerformanceCounterManager(Configit.SignalR.Tracing.ITraceManager traceManager)
            : this()
        {
...
#pragma warning disable 618
          return typeof(System.Diagnostics.PerformanceCounterManager)
