...
using Configit.SignalR.Transports;
...
namespace Configit.SignalR
{
    ...
    public abstract class PersistentConnection
    {
                                           ...
                                           out int statusCode)
        {
            ...
            {
                System.Diagnostics.Trace.TraceInformation("Failed to process connectionToken {0}: {1}", connectionToken, ex);
            }
        ...
        internal IList<string> VerifyGroups(HostContext context, string connectionId)
        {
            ...
            {
                System.Diagnostics.Trace.TraceInformation("Failed to process groupsToken {0}: {1}", groupsToken, ex);
            }
