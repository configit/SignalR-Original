...
namespace Configit.SignalR.Messaging
{
    ...
    public sealed class ScaleoutStore
    {
        ...
        {
            ulong nextFreeMessageId = (ulong)System.Threading.Volatile.Read(ref _nextFreeMessageId);
        ...
        public MessageStoreResult<ScaleoutMapping> GetMessages(ulong firstMessageIdRequestedByClient)
        {
            ...
            while (true)
            {
                ...
                nextFreeMessageId = (ulong)System.Threading.Volatile.Read(ref _nextFreeMessageId);
            }
        }

        public MessageStoreResult<ScaleoutMapping> GetMessagesByMappingId(ulong mappingId)
        {
            var minMessageId = (ulong)System.Threading.Volatile.Read(ref _minMessageId);
