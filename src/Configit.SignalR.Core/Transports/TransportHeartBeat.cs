...
using Configit.SignalR.Configuration;
...
namespace Configit.SignalR.Transports
{
    ...
    public class TransportHeartbeat : ITransportHeartbeat, IDisposable
    {
        ...
        public ITrackingConnection AddOrUpdateConnection(ITrackingConnection connection)
        {
            ...
            if (isNewConnection)
            {
                System.Diagnostics.Trace.TraceInformation("Connection {0} is New.", connection.ConnectionId);
            }
        ...
        public void RemoveConnection(ITrackingConnection connection)
        {
            ...
            if (_connections.TryRemove(connection.ConnectionId, out metadata))
            {
                ...
                System.Diagnostics.Trace.TraceInformation("Removing connection {0}", connection.ConnectionId);
            }
        }
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                System.Diagnostics.Trace.TraceInformation("Dispose(). Closing all connections");
