...
namespace Configit.SignalR.Transports
{
    ...
    public abstract class TransportDisconnectBase : ITrackingConnection
    {
        ...
        private Task Abort(bool clean)
        {
            ...
            System.Diagnostics.Trace.TraceInformation("Abort(" + ConnectionId + ")");
        ...
        public void Timeout()
        {
            ...
            {
                System.Diagnostics.Trace.TraceInformation("Timeout(" + ConnectionId + ")");
        ...
        public void End()
        {
            ...
            {
                System.Diagnostics.Trace.TraceInformation("End(" + ConnectionId + ")");
